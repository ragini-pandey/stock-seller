  ...
  const fetchAllPrices = async (stocks: WatchlistStock[]) => {
    ...
    try {
      ...
      toast({
        ...
        description: error instanceof Error ? error.message : "Network error while fetching prices",
        variant: "destructive",
      });
    }
  ...
  const fetchRecommendations = async (stocks: WatchlistStock[]) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          error instanceof Error ? error.message : "Network error while fetching recommendations",
        variant: "destructive",
      });
    }
